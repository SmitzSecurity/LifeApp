...
function failedBuild(build:Build){
 if(build.errorCode==='provider_request_rejected')return 'The AI service rejected the request before generation. Refresh before trying again; nothing was added.';
