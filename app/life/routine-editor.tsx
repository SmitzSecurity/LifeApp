...
export default function RoutineEditor({routine,onChange,onSave,onCancel,busy,pending,error,initialExerciseId,session=false}:{session?:boolean;initialExerciseId?:string;routine:Saved<Routine>;onChange:(r:Routine)=>void;onSave:()=>void;onCancel:()=>void;busy:boolean;pending:boolean;error:string}){
