...
- [Responses and prototype limits](docs/responses-and-owner-limits.md): yesterday's analysis above saved history, an on-demand journal dialog with voice input, confirmed trash icons, timezone dropdown, and a private expiring owner allowance with unchanged customer/default safeguards.
