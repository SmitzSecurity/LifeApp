...
test('actual private export validates losslessly with archived habits, workout snapshots and linked reviews',async()=>{
 ...
 assert.deepEqual(preview.source.resourceKinds,{budget:1,transaction:1,routine:1,workout:1,cardio:0,'workout-note':0});assert.equal(preview.source.measuredCostMicros,600);
