...
export function defaultReviewPreferences():z.infer<typeof reviewPreferencesSchema>{const option={enabled:true,time:'04:00',focus:'',tone:'balanced' as const,detail:'brief' as const};return {intent:'',daily:{...option},weekly:{...option,detail:'standard'},monthly:{...option,detail:'standard'},annual:{...option,detail:'standard'},weekDay:1,monthDay:1,annualMonth:1,annualDay:1,emailEnabled:false,remindersEnabled:true,localEventsEnabled:false,eventArea:'',biographyEnabled:false,biographyFocus:''};}
